...
func (r *inventoryRepository) Create(ctx context.Context, item *domain.InventoryItem) error {
	...
	_, err := r.db.ExecContext(ctx, query,
		...
		item.CostPrice, item.SellingPrice, item.MarginPercentage,
...
func (r *inventoryRepository) Update(ctx context.Context, item *domain.InventoryItem) error {
	query := `
		UPDATE inventory_items SET
			...
			cost_price = $11, selling_price = $12, margin_percentage = $13,
			supplier_id = $14, supplier_name = $15, purchase_invoice = $16,
			min_stock_level = $17, reorder_point = $18, shelf_life_days = $19,
			storage_location = $20, barcode = $21, sku = $22, hsn_code = $23,
			gst_rate = $24, status = $25, weight_per_unit = $26, packaging_type = $27,
			image_url = $28, notes = $29, total_sold = $30, total_wasted = $31,
			last_restock_date = $32, updated_at = $33
		WHERE id = $1 AND deleted_at IS NULL`
