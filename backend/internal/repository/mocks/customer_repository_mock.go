...
type MockCustomerRepository struct {
	...
	GetByContactNumberFunc    func(ctx context.Context, contactNumber string) (*domain.Customer, error)
...
func (m *MockCustomerRepository) GetByContactNumber(ctx context.Context, contactNumber string) (*domain.Customer, error) {
	if m.GetByContactNumberFunc != nil {
		return m.GetByContactNumberFunc(ctx, contactNumber)
	}
	return nil, domain.ErrNotFound
}
